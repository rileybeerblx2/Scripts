...
function CreateTab(name, rainbow, color)
	tabcount = tabcount+1
...
function MakeButton(tab,text,callback)
...
function MakeToggle(tab,text,default,callback)
	buttoncount[tonumber(tab.Name)] = buttoncount[tonumber(tab.Name)]+1
...
function MakeBox(tab,text,placeholder,callback)
	buttoncount[tonumber(tab.Name)] = buttoncount[tonumber(tab.Name)]+1
	local fontsize
...
function MakeDropdown(tab,text,drops,default,callback)
	buttoncount[tonumber(tab.Name)] = buttoncount[tonumber(tab.Name)]+1
	local def = ""
