...
local win = library:Window("Riley Hub V4 - Blox Fruit",[[ BLACK]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
...
Island_Tab:Button("Teleport to First Sea", function()
	Com()
	TP_World1()
end)
Island_Tab:Button("Teleport to Second Sea", function()
	Com()
	TP_World2()
end)

Island_Tab:Button("Teleport to Third Sea", function()
	Com()
	TP_World3()
end)
