...
AntiLava.CanCollide = false
                ...
                local Window = OrionLib:MakeWindow({Name = "Riley Hub V4 - Slap Battles", HidePremium = true, IntroEnabled = false, SaveConfig = false, ConfigFolder = "OrionTest"})
